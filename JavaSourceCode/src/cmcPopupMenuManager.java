...
public class cmcPopupMenuManager {
	...
	//---------------------------------------------------------------------------------
	{
		...
		if( (as == cbrTekStraktorModel.cmcProcEnums.APPLICATION_STATE.IMAGE) ) {
		    ...
		    setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.INVERT, true );
		    ...
		    setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.VERTICAL_GRADIENT , true );
		    setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.HORIZONTAL_GRADIENT , true );
		    setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.GRADIENT_MAGNITUDE , true );
		    setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.GRADIENT_THETA , true );
		    //
			setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.STATISTICS , true );
			setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.ARCHIVE_BROWSER , true );
			setMenuItemVisible( cbrTekStraktorModel.cmcProcEnums.POP_ITEMS.ARCHIVE_VIEWER , true );
